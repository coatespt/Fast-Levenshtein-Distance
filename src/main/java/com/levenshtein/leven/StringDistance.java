 ...
 * 
 * Note that LD creates and manipulates an array of integers of size N * M where N and M * are the 
 * size of the two sequences.  This implies at least quadratic complexity in both space and time.
 * 
 * @author pcoates
 */
